...
const validGraph = {
  nodes: [
    { id: "client", type: "tool", data: { label: "Web App", category: "Frontend", description: "User interface" } },
    { id: "api", type: "tool", data: { label: "Cloud Run", category: "API", description: "Server routes" } },
    { id: "model", type: "tool", data: { label: "OpenRouter", category: "AI", description: "Model gateway" } },
    { id: "metrics", type: "tool", data: { label: "Artificial Analysis", category: "Data", description: "Model metrics" } },
  ],
  edges: [
